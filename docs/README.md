...
- [Architecture & infrastructure](./architecture.md) — the system view: the six
  ...
  model, scalability (more workers, Postgres ceiling, when/how to move to k8s),
  the reasoning behind the big decisions, and the small-vs-real deployment
  profiles. Start here for the whole-system picture; `deploy/README.md` is the
  operational runbook.

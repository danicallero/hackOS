...
- `deploy/` — canonical Docker Compose runtime for the ARM64 staging host and
  the production `hackos` LXC; `deploy/README.md` is normative.
...
GHCR images: staging runs on an ARM64 host and production runs in the

...
export default function QueuePage() {
  ...
  if (!canUse) {
    return (
      <div className="space-y-6">
        <PageHeader title="Queue & judging" />
        <EmptyState
          icon={LockIcon}
          title="You can't access the judging panel"
          description="Queue and judging access requires an operator, admin or judge capability."
        />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Queue & judging"
        description="Run room queues, present teams, save judging reviews and monitor challenge progress."
        actions={
          canAdmin ? (

...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("type-section-title text-balance", className)}
      {...props}
    />
  )
}

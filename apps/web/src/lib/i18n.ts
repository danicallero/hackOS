...
const dict: Record<string, I18nText> = {
  ...
  tooShort: { es: "Es demasiado corto.", gl: "É demasiado curto.", en: "This is too short." },
  tooLong: { es: "Es demasiado largo.", gl: "É demasiado longo.", en: "This is too long." },
  invalidFormat: {
    es: "El formato no es válido.",
    gl: "O formato non é válido.",
    en: "The format isn't valid.",
  },
  tooSmall: {
    es: "El valor es demasiado bajo.",
    gl: "O valor é demasiado baixo.",
    en: "This value is too low.",
  },
  tooLarge: {
    es: "El valor es demasiado alto.",
    gl: "O valor é demasiado alto.",
    en: "This value is too high.",
  },
  tooFewSelected: {
    es: "Selecciona más opciones.",
    gl: "Selecciona máis opcións.",
    en: "Select more options.",
  },
  tooManySelected: {
    es: "Selecciona menos opciones.",
    gl: "Selecciona menos opcións.",
    en: "Select fewer options.",
  },
  mustContainText: {
    es: "Debe contener un texto concreto.",
    gl: "Debe conter un texto concreto.",
    en: "Must contain specific text.",
  },
  mustNotContainText: {
    es: "No debe contener un texto concreto.",
    gl: "Non debe conter un texto concreto.",
    en: "Must not contain specific text.",
  },
  invalidEmail: {
    es: "Introduce un correo válido.",
    gl: "Introduce un correo válido.",
  ...
  restrictFileTypesLabel: {
    es: "Permitir solo ciertos tipos de archivo",
    gl: "Permitir só certos tipos de ficheiro",
    en: "Allow only specific file types",
  },
  ...
  editInProfileLink: {
    es: "Editar en el perfil del solicitante",
    gl: "Editar no perfil do solicitante",
    en: "Edit on the applicant's profile",
  },
  ...
  sections: { es: "Secciones", gl: "Seccións", en: "Sections" },
  addSection: { es: "Añadir sección", gl: "Engadir sección", en: "Add section" },
  noSection: { es: "Sin sección", gl: "Sen sección", en: "No section" },
  noSectionsYetDesc: {
    es: "Agrupa preguntas relacionadas bajo un título y una descripción opcional.",
    gl: "Agrupa preguntas relacionadas baixo un título e unha descrición opcional.",
    en: "Group related questions under a title and an optional description.",
  },
  sectionTitleLabel: { es: "Título de la sección", gl: "Título da sección", en: "Section title" },
  sectionDescriptionLabel: {
    es: "Descripción de la sección",
    gl: "Descrición da sección",
    en: "Section description",
  },
  removeSection: { es: "Eliminar sección", gl: "Eliminar sección", en: "Remove section" },
  everySectionNeedsKey: {
    es: "Toda sección necesita una clave.",
    gl: "Toda sección precisa unha clave.",
    en: "Every section needs a key.",
  },
  sectionKeyMustBeAlphanumeric: {
    es: 'La clave de sección "{key}" debe ser alfanumérica.',
    gl: 'A clave de sección "{key}" debe ser alfanumérica.',
    en: 'Section key "{key}" must be alphanumeric.',
  },
  duplicateSectionKey: {
    es: 'Clave de sección duplicada "{key}".',
    gl: 'Clave de sección duplicada "{key}".',
    en: 'Duplicate section key "{key}".',
  },
  fieldReferencesMissingSection: {
    es: 'La pregunta "{key}" apunta a una sección que no existe.',
    gl: 'A pregunta "{key}" apunta a unha sección que non existe.',
    en: 'Question "{key}" points to a section that does not exist.',
  },
  dragToReorder: {
    es: "Arrastrar para reordenar",
    gl: "Arrastrar para reordenar",
    en: "Drag to reorder",
  },
  dragSectionToReorder: {
    es: "Arrastrar sección para reordenar",
    gl: "Arrastrar sección para reordenar",
    en: "Drag section to reorder",
  },
  dropQuestionsHereDesc: {
    es: "Arrastra una pregunta aquí",
    gl: "Arrastra unha pregunta aquí",
    en: "Drag a question here",
  },
  helpTextLabel: { es: "Texto de ayuda", gl: "Texto de axuda", en: "Help text" },
  placeholderTextLabel: {
    es: "Texto de ejemplo",
    gl: "Texto de exemplo",
    en: "Placeholder text",
  },
  duplicateQuestion: { es: "Duplicar pregunta", gl: "Duplicar pregunta", en: "Duplicate question" },
  moreOptions: { es: "Más opciones", gl: "Máis opcións", en: "More options" },
  responseValidation: {
    es: "Validación de respuesta",
    gl: "Validación de resposta",
    en: "Response validation",
  },
  minLengthLabel: { es: "Longitud mínima", gl: "Lonxitude mínima", en: "Minimum length" },
  patternLabel: { es: "Patrón (regex)", gl: "Patrón (regex)", en: "Pattern (regex)" },
  minValueLabel: { es: "Valor mínimo", gl: "Valor mínimo", en: "Minimum value" },
  maxValueLabel: { es: "Valor máximo", gl: "Valor máximo", en: "Maximum value" },
  customErrorMessageLabel: {
    es: "Mensaje de error personalizado",
    gl: "Mensaxe de erro personalizada",
    en: "Custom error message",
  },
  validationCategoryLabel: {
    es: "Tipo de validación",
    gl: "Tipo de validación",
    en: "Validation type",
  },
  validationCategoryText: { es: "Texto", gl: "Texto", en: "Text" },
  validationCategoryLength: { es: "Longitud", gl: "Lonxitude", en: "Length" },
  validationCategoryRegex: {
    es: "Expresión regular",
    gl: "Expresión regular",
    en: "Regular expression",
  },
  conditionLabel: { es: "Condición", gl: "Condición", en: "Condition" },
  conditionContains: { es: "Contiene", gl: "Contén", en: "Contains" },
  conditionNotContains: { es: "No contiene", gl: "Non contén", en: "Doesn't contain" },
  conditionEmail: { es: "Es un correo", gl: "É un correo", en: "Is an email" },
  conditionUrl: { es: "Es una URL", gl: "É unha URL", en: "Is a URL" },
  selectConditionLabel: { es: "Condición", gl: "Condición", en: "Condition" },
  selectAtLeast: {
    es: "Seleccionar como mínimo",
    gl: "Seleccionar como mínimo",
    en: "Select at least",
  },
  selectAtMost: {
    es: "Seleccionar como máximo",
    gl: "Seleccionar como máximo",
    en: "Select at most",
  },
  selectExactly: {
    es: "Seleccionar exactamente",
    gl: "Seleccionar exactamente",
    en: "Select exactly",
  },
  countLabel: { es: "Número", gl: "Número", en: "Number" },

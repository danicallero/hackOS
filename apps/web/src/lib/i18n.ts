...
const dict: Record<string, I18nText> = {
  ...
  eventDesc: {
    es: "Identidad y ventana pública del hackathon. Las horas de inicio/fin controlan la cuenta atrás en la web y las pantallas de TV.",
    gl: "Identidade e ventá pública do hackathon. As horas de inicio/fin controlan a conta atrás na web e nas pantallas de TV.",
    en: "Identity and the public hacking window. Start/end times drive the countdown on the website and TV panels.",
  },
  ...
  hackingStartsLabel: {
    es: "Empieza el hackathon",
    gl: "Comeza o hackathon",
    en: "Hacking starts",
  },
  hackingEndsLabel: { es: "Termina el hackathon", gl: "Remata o hackathon", en: "Hacking ends" },

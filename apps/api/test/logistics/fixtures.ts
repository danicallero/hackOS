 ...
 * an event-bearing role — otherwise wallet-pass issuance would reject it as
 * not currently entitled, and badge/wallet/scanner code would show no role
 * name instead of "Participant".
 */

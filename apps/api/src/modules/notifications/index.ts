 ...
 * dispatcher.ts and announcements-publisher.ts for the two background jobs;
 * service.ts's `notify()` is the contract other modules import to enqueue
 * notifications (raw INSERT into notification_outbox also works, siblings
 * already do that in a few places).
 */

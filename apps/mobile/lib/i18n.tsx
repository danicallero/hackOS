...
const dict = {
  ...
  eventAccessNotice: {
    en: "Applications and account setup happen on {website}. Accepted participants and event team members use the app with the same email and password. Need help? Contact the organization.",
    es: "Las solicitudes y la creación de cuentas se hacen en {website}. Los participantes aceptados y el equipo del evento usan la app con el mismo correo y contraseña. ¿Necesitas ayuda? Contacta con la organización.",
    gl: "As solicitudes e a creación de contas fanse en {website}. As persoas participantes aceptadas e o equipo do evento usan a app co mesmo correo e contrasinal. Necesitas axuda? Contacta coa organización.",
  },
  mobileAccessDenied: {
    en: "This account doesn't have access to the event app yet. Review your application or account setup on {website}. Access is available to accepted participants and event team members.",
    es: "Esta cuenta todavía no tiene acceso a la app del evento. Revisa tu solicitud o la configuración de tu cuenta en {website}. El acceso está disponible para participantes aceptados y miembros del equipo.",
    gl: "Esta conta aínda non ten acceso á app do evento. Revisa a túa solicitude ou a configuración da conta en {website}. O acceso está dispoñible para participantes aceptados e membros do equipo.",
  },
  ...
  sessionRestoringTitle: {
    ...
    gl: "Restaurando a túa sesión",
  },
  sessionRestoringDescription: {
    en: "Checking your account before opening the event app.",
    es: "Estamos comprobando tu cuenta antes de abrir la app del evento.",
    gl: "Estamos comprobando a túa conta antes de abrir a app do evento.",
  },
  sessionRecoveryTitle: {
    en: "Your session needs attention",
    es: "Tu sesión necesita atención",
    gl: "A túa sesión precisa atención",
  },
  sessionRecoveryDescription: {
    en: "We couldn't verify your account. Try again or sign out and sign in again.",
    es: "No se pudo verificar tu cuenta. Vuelve a intentarlo o cierra sesión y entra de nuevo.",
    gl: "Non se puido verificar a túa conta. Téntao de novo ou pecha sesión e volve entrar.",
  },
  offlineDataTitle: {
